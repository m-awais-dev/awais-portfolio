        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              <div className="absolute left-3 flex h-10 w-10 items-center justify-center rounded-full border border-gray-700 bg-gray-900 dark:bg-gray-900 md:left-3">
                <div className="h-4 w-4 rounded-full border border-blue-400 bg-blue-500 p-2 dark:border-blue-400 dark:bg-blue-500" />
              </div>
              <h3 className="hidden text-xl font-bold text-blue-400 dark:text-blue-400 md:block md:pl-20 md:text-5xl">
                {item.title}
              </h3>
            </div>

            <div className="relative w-full pl-20 pr-4 md:pl-4">
              <h3 className="mb-4 block text-left text-2xl font-bold text-blue-400 dark:text-blue-400 md:hidden">
                {item.title}
              </h3>
              {item.content}{' '}
            </div>
